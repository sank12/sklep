      ...
      <div class="row">
       ...
       <div class="col-md-8">
        ...
        <div class="col-md-4">
              ...
              {
                  ?>
                        <a href="login.php" class="btn btn-block btn-success btn-lg">Zaloguj</button>
...
{
    $cena = 0;
    $wynik = mysql_query("SELECT magazyn.cena, sprzedaz.ilosc FROM sprzedaz INNER JOIN produkty ON produkty.id_produktu = sprzedaz.id_produktu WHERE id_zamowienia=$id_zamowienia AND id_uzytkownika=$id_usera");
    while($r = mysql_fetch_assoc($wynik))
    {
        $cena += $r['cena']*$r['ilosc'];
    }
