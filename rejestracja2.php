...
if($licznik_bledow == 0) 
{
    ...
    // ta linijka nzej sie nie robi wspaniale !
    // // zamknij ryj bo zaraz do marty napisze....
    // // z twojego konta :D
    // bo nie masz zmiennej $login
    // POKAZ mi gdzie się łączysz z bazą w tym pliku. . . . . . (facebpalm_
    $login = $_POST['r_login'];
